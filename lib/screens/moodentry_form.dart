...
// Impor drawer yang sudah dibuat sebelumnya (tidak dilakukan agar tombol back dapat muncul)
...
class _MoodEntryFormPageState extends State<MoodEntryFormPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // Tambahkan drawer yang sudah dibuat di sini ((tidak dilakukan agar tombol back dapat muncul)
      body: Form(
        key: _formKey,
